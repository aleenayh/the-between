...
export function PullOutDrawer({ isOpen, setIsOpen, children }: { isOpen: boolean, setIsOpen: (isOpen: boolean) => void, children: React.ReactNode }) {
  ...
  return (
    ...
    <motion.div
      ...
      className="absolute top-0 left-0 w-full pb-10 md:pb-4 md:w-1/2 h-screen flex flex-col justify-start items-center bg-theme-bg-primary border-r border-theme-border-accent rounded-lg p-4 z-10 overflow-y-auto pointer-events-auto"
    >
