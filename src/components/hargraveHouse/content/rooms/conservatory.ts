...
export const conservatoryContent: RoomContent = {
	...
	onUnlock: { text: [
		...
		"<li>Increase your Sensitivity by 2 (max 3) as your mind opens up to the infinite possibilities of the universe, and then take the Condition: I Am. This Condition can never be cleared. </li>",
		"<li><check>Increase your Reason by 2 (max 3) as your mind becomes a perfect grid for organizing and tracking your prey, and then take the Condition: Roger. This Condition can never be cleared.</li>",
		"<li><check>Increase your Vitality by 2 (max 3) as the power of the Reaver courses through you. Describe how your body outwardly manifests this change, and then take the Condition: The Reaver. This Condition can never be cleared. </li>",
