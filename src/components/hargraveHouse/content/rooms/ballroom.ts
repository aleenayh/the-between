...
export const ballroomContent: RoomContent = {
	...
	prompts: [
		"Paint the Scene: This ballroom has gone unused for years, since a fête held for a delegation of fae ended in turmoil. During their furious exit, the fae marked this ballroom as anathema: tainted ground on which no fae would tread. Which of these marks can the hunters perceive, marring the space?",
	...
	onUnlock: {
		text: [
			"Unlocked: Merricat Ovelia can act as an etiquette guide and translator on behalf of the Hunters when dealing with the fae. For any future encounters with the fae, you can, on three occasions, enlist Merricat's aid to roll with advantage. ",
			...
			"The Transgression: You have been taught an act that, when performed, will cause all fae who witness it to immediately vacate the area and shun you. Never describe it. When performed, take the Condition: Boorish.",
		],
		checks: 3,
	},
};
