...
export const Nameless: PlaybookBase = {
	title: "The Nameless",
	intro: ["Aleena didn't port this over yet."],
	names: [
		"Alyndra",
		"Beryn",
		"Corinelle",
	...
	cinders: [
		"The Watchful Flame - Light reveals what burns within.",
		"The Burden of Wax - All illumination comes at a cost.",
		"The Long Night - The dark is patient, and it always returns.",
		"The Kindled Heart - To bear light is to burn.",
		"The Last Glow - Even the smallest flame defies eternity.",
	],
	relics: [
		{
